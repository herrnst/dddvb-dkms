...
int main(int argc, char *argv[])
{
	...
	switch(Flash)
	{
        case ATMEL_AT45DB642D: err = FlashWriteAtmel(ddb,FlashOffset,Buffer,BufferSize); break;
        case SSTI_SST25VF016B: 
        case SSTI_SST25VF032B: err = FlashWriteSSTI(ddb,FlashOffset,Buffer,BufferSize); break;
	}
